...
first_user = User.create(name: 'Tom', photo: 'https://placehold.co', bio: 'Teacher from Mexico.', posts_counter: 0)
second_user = User.create(name: 'Lilly', photo: 'https://placehold.co', bio: 'Teacher from Poland.', posts_counter: 0)
